        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-0">
            ...
            <div className="bg-[var(--cream)] border border-[var(--charcoal)] p-8 text-center">
              ...
              <p className="text-xl text-[var(--charcoal)] font-bold" style={{ fontFamily: 'var(--font-cinzel)' }}>
                A Private Resort
              </p>
            ...
            {[
              ...
              <div key={i} className={`flex items-start gap-6 p-6 border-l-4 ${i === 5 ? 'border-[var(--charcoal)] bg-[var(--charcoal)] text-[var(--cream)]' : 'border-[var(--charcoal)]/50 bg-[var(--cream)]'}`}>
                <div className={`w-10 h-10 flex items-center justify-center border-2 ${i === 5 ? 'border-[var(--cream)]' : 'border-[var(--charcoal)]'} flex-shrink-0`}>
                  <span className="font-bold" style={{ fontFamily: 'var(--font-cinzel)' }}>{i + 1}</span>
                </div>
                <div>
                  <h3 className={`text-xl font-bold mb-2 tracking-wider ${i === 5 ? 'text-[var(--cream)]' : ''}`} style={{ fontFamily: 'var(--font-cinzel)' }}>
                    {item.title}
                  </h3>
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
              ...
              <div className="border-2 border-[var(--cream)] p-6 md:p-8 bg-[var(--charcoal)]">
                <h3 className="text-xl font-bold text-[var(--cream)] mb-6 tracking-wider" style={{ fontFamily: 'var(--font-cinzel)' }}>
                  Section I: Identity Verification
                </h3>
              ...
              <div className="border-4 border-[var(--cream)] p-6 md:p-8 bg-[var(--cream)] text-[var(--charcoal)]">
                <h3 className="text-xl font-bold mb-6 tracking-wider" style={{ fontFamily: 'var(--font-cinzel)' }}>
                  Section VI: Sacred Oath
                </h3>
                <div className="space-y-6">
                  <div>
      ...
      <section className="py-32 px-6 bg-[var(--cream)] text-[var(--charcoal)] relative">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="border-t border-[var(--charcoal)]/30 pt-12">
            ...
            <p className="text-2xl font-bold tracking-wider mt-2" style={{ fontFamily: 'var(--font-cinzel)' }}>
              401KULT
            </p>
          </div>
